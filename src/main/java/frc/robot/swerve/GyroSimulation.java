...
public class GyroSimulation {
     ...
     *                                                        the user
     *                                                        manual.
     * @param VELOCITY_MEASUREMENT_STANDARD_DEVIATION_PERCENT the standard deviation
     *                                                        of the velocity
     *                                                        measurement,
     ...
     *
     * <p>
     * This method returns the angular velocity measured by the gyro, in radians per
     * second.
     *
     * <p>
     ...
     *
     * @param actualAngularVelocityRadPerSec the actual angular velocity in radians
    ...
    private Rotation2d getDriftingDueToImpact(double actualAngularVelocityRadPerSec) {
        final double angularAccelerationRadPerSecSq = (actualAngularVelocityRadPerSec
                ...
                driftingDueToImpactDegAbsVal = Math
                        .abs(angularAccelerationRadPerSecSq) > ANGULAR_ACCELERATION_THRESHOLD_START_DRIFTING
     ...
     *
     * <p>
     * This method simulates the change in the robot's angle (ΔTheta) since the last
