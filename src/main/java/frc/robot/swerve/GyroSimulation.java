...
// *
// * <p>
// * The Simulation is basically an indefinite integral of the angular velocity
// * during each simulation sub ticks. Above
// * that, it also musicales the measurement inaccuracy of the gyro, drifting in
// * no-motion and drifting due to impacts.
// */
...
// private double measuredAngularVelocityRadPerSec,
...
// *
// * @param AVERAGE_DRIFTING_IN_30_SECS_MOTIONLESS_DEG the average amount of
// * drift, in degrees, the
// * gyro experiences
// * if it remains
// * motionless for 30
// * seconds on a vibrating
// * platform. This value
// * can often be found in
// * the user
// * manual.
// * @param VELOCITY_MEASUREMENT_STANDARD_DEVIATION_PERCENT the standard
// deviation
// * of the velocity
// * measurement,
...
// double AVERAGE_DRIFTING_IN_30_SECS_MOTIONLESS_DEG, double
// VELOCITY_MEASUREMENT_STANDARD_DEVIATION_PERCENT) {
...
// this.previousAngularVelocityRadPerSec = this.measuredAngularVelocityRadPerSec
// = 0;
...
// *
// * <p>
// * This method sets the current rotation of the gyro, similar to
// * <code>Pigeon2().setYaw()
// * </code>.
// *
// * <p>
// * After setting the rotation, the gyro will continue to estimate the rotation
// * by integrating the angular
// * velocity, adding it to the specified rotation.
// *
// * @param currentRotation the current rotation of the robot, represented as a
// * {@link Rotation2d}
// */
...
// *
// * <p>
// * This method returns the estimated rotation of the gyro, which includes
// * measurement errors due to drifting and
// * other factors.
// *
// * @return the current reading of the gyro, represented as a {@link
// Rotation2d}
// */
...
// *
// * <p>
// * This method returns the angular velocity measured by the gyro, in radians
// per
// * second.
// *
// * <p>
// * The measurement includes random errors based on the configured settings of
// * the gyro.
// *
...
// *
// * <p>
// * This method updates the gyro simulation and should be called during every
// * sub-tick of the simulation.
// *
// * <p>
// * If you are using this class outside of
// * {@link org.ironmaple.simulation.SimulatedArena}: make sure to call it 5
// * times in each robot period (if using default timings), or refer to
// * {@link
// org.ironmaple.simulation.SimulatedArena#overrideSimulationTimings(Time,
// int)}.
// *
// * @param actualAngularVelocityRadPerSec the actual angular velocity in
// radians
// * per second, usually obtained from
...
// *
// * <p>
// * This method generates a random amount of drifting for the IMU if the
// * instantaneous angular acceleration
// * exceeds a threshold, simulating the effects of impacts on the robot.
// *
// * @param actualAngularVelocityRadPerSec the actual angular velocity in
// radians
// * per second, used to determine if an
// * impact is detected
// * @return the amount of drifting the IMU will experience if an impact is
// * detected, or <code>
// * Rotation2d.fromRadians(0)</code> if no impact is detected
// */
// private Rotation2d getDriftingDueToImpact(double
// actualAngularVelocityRadPerSec) {
// final double angularAccelerationRadPerSecSq = (actualAngularVelocityRadPerSec
// - previousAngularVelocityRadPerSec)
// / SimulatedArena.getSimulationDt().in(Seconds),
// driftingDueToImpactDegAbsVal = Math
// .abs(angularAccelerationRadPerSecSq) >
// ANGULAR_ACCELERATION_THRESHOLD_START_DRIFTING
// ? Math.abs(angularAccelerationRadPerSecSq)
// / ANGULAR_ACCELERATION_THRESHOLD_START_DRIFTING
// * DRIFT_DUE_TO_IMPACT_COEFFICIENT
// : 0,
// driftingDueToImpactDeg = Math.copySign(driftingDueToImpactDegAbsVal,
...
// *
// * <p>
// * This method simulates the change in the robot's angle (ΔTheta) since the
// last
// * sub-tick, as measured by the
// * gyro.
// *
// * <p>
// * The measurement includes random errors based on the configuration of the
// * gyro.
// *
// * @param actualAngularVelocityRadPerSec the actual angular velocity in
// radians
// * per second, used to calculate the
// * ΔTheta
...
// *
// * <p>
// * This method simulates the minor drifting of the gyro that occurs regardless
// * of whether the robot is moving or
// * not.
// *
// * @return the amount of drifting generated while the robot is not moving
// */
// private Rotation2d getNoMotionDrifting() {
// final double AVERAGE_DRIFTING_1_PERIOD =
// this.AVERAGE_DRIFTING_IN_30_SECS_MOTIONLESS_DEG
// / 30
// * SimulatedArena.getSimulationDt().in(Seconds),
// driftingInThisPeriod = MapleCommonMath.generateRandomNormal(0,
