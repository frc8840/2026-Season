...
public class IntakePosSubsystem extends SubsystemBase {
  ...
  public IntakePosSubsystem() {
    ...
    motor.setPosition(0); // assume the arm is in rest position at the start
  }
  ...
  public void setIntakePositionRotations(double position) {
    ...
    // Logger.Log("Shoulder motor thinks it is at " + motor.getPosition().getValueAsDouble());
